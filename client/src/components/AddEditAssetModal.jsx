...
export default function AddEditAssetModal({ isOpen, onClose, onSuccess, asset = null, locations = [], employees = [], categories = [] }) {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Status {formData.assignedToEmployeeId && <span className="text-gray-500 text-xs">(auto-set)</span>}
              </label>
              <select
                name="status"
                value={formData.status}
                onChange={handleChange}
                disabled={!!formData.assignedToEmployeeId}
